...
const okex_node_2 = require("@okfe/okex-node");
...
function publicInfo() {
    if (_instance === undefined) {
        _instance = {};
        _instance.wss = new okex_node_2.V3WebsocketClient(config.websocekHost);
        _instance.pClient = okex_node_1.PublicClient(config.urlHost);
